...
```{r}
schools_2 <- schools[which(schools$`School Metro Type` != "unknown"), c(3,4)]
ggplot(schools_2, aes(x = `School Percentage Free Lunch`, y = ..density..)) + 
    geom_histogram(fill = "darkseagreen", colour = "ghostwhite", size = 0.4) +
...
ggplot(resources, aes(x = `Resource Total Price`, y = ..density..)) + 
    geom_histogram(fill = "slateblue1", colour = "thistle4", size = 0.4) +
    geom_density()
```